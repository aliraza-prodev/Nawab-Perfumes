...
//             if(pageTitle) pageTitle.textContent = `${product.name} – Nawab Fragrances Perfumes`;
//             document.querySelector('meta[name="description"]').setAttribute('content', product.description);
//             document.querySelector('meta[property="og:title"]').setAttribute('content', `${product.name} – Nawab Fragrances Perfumes`);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const products = [
        // --- Men's Collection ---
        { id: 'rose-vintage', name: 'Nawab Saheb', tagline: 'Timeless floral elegance', description: 'A classic, sophisticated rose fragrance...', ingredients: ['...'], price: 120, image: 'assets/Nawab-Saheb-100ml.png', images: ['...'], reviews: ['...'], sizes: ['30ml', '50ml', '100ml'], category: 'men' },
        { id: 'oud-elixir', name: 'Nawabzada', tagline: 'Mysterious, deep & captivating', description: 'An enchanting blend of rare Oud wood...', ingredients: ['...'], price: 180, image: 'assets/Nawabzada-100ml.png', images: ['...'], reviews: ['...'], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'citrus-bloom', name: 'Kingdom', tagline: 'Fresh, vibrant & invigorating', description: 'A burst of fresh citrus notes...', ingredients: ['...'], price: 95, image: 'assets/kingdom-100ml.png', images: ['...'], reviews: ['...'], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'velvet-night', name: 'Time less', tagline: 'Rich, sensual & alluring', description: 'A deep, mysterious fragrance...', ingredients: ['...'], price: 150, image: 'assets/Timeless-100ml.png', images: ['...'], reviews: ['...'], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'aqua-dream', name: 'Era', tagline: 'Clean, crisp & refreshing', description: 'An invigorating oceanic scent...', ingredients: ['...'], price: 110, image: 'assets/Era-100ml.png', images: ['...'], reviews: ['...'], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'spiced-saffron', name: 'Aura', tagline: 'Warm, exotic & inviting', description: 'A captivating blend of warm spices...', ingredients: ['...'], price: 135, image: 'assets/Aura-100ml.png', images: ['...'], reviews: ['...'], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'golden-dawn', name: 'Crush', tagline: 'Radiant & uplifting citrus', description: 'Awaken your senses with this bright...', ingredients: ['...'], price: 105, image: 'assets/Crush-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'midnight-bloom', name: 'VIP Gold', tagline: 'Enigmatic & sophisticated floral', description: 'A captivating nocturnal floral...', ingredients: ['...'], price: 140, image: 'assets/Vip-Gold-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'desert-spice', name: 'Cool', tagline: 'Warm, arid & adventurous', description: 'Experience the dry warmth of desert spices...', ingredients: ['...'], price: 165, image: 'assets/Cool-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'silver-mist', name: 'White Oud Premium', tagline: 'Cool, ethereal & subtle', description: 'A light, airy scent reminiscent...', ingredients: ['...'], price: 85, image: 'assets/White-Oud-Premium-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'forest-whisper', name: 'Special Oud', tagline: 'Earthy, green & serene', description: 'Immerse yourself in the tranquility...', ingredients: ['...'], price: 115, image: 'assets/Special-Oud-100ml.png', images: ['...'], reviews: [], sizes: ['50ml'], category: 'men' },
        { id: 'ruby-nectar', name: 'Corporate', tagline: 'Sweet, fruity & enchanting', description: 'A luscious blend of ripe berries...', ingredients: ['...'], price: 125, image: 'assets/Corporate-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml', '100ml'], category: 'men' },
        { id: 'amber-glow', name: 'Nawab creed', tagline: 'Warm, resinous & comforting', description: 'Wrap yourself in the golden warmth...', ingredients: ['...'], price: 145, image: 'assets/Creed-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'celestial-powder', name: 'Nawab office', tagline: 'Soft, powdery & elegant', description: 'A delicate and sophisticated powdery scent...', ingredients: ['...'], price: 100, image: 'assets/Nawab-Office-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'mystic-leather', name: 'Nawab Blue D', tagline: 'Bold, smoky & intriguing', description: 'A daring blend of rich leather...', ingredients: ['...'], price: 175, image: 'assets/Nawab-Blue-D-100ml.png', images: ['...'], reviews: [], sizes: ['100ml'], category: 'men' },
        { id: 'green-fig', name: 'Nawab T leather', tagline: 'Crisp, leafy & earthy', description: 'Captures the essence of a sun-drenched fig tree...', ingredients: ['...'], price: 90, image: 'assets/Nawab-T-Leather-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'spiced-vanilla', name: 'Nawab H Boss', tagline: 'Warm, sweet & inviting', description: 'A comforting blend of creamy vanilla...', ingredients: ['...'], price: 110, image: 'assets/Nawab-H-Boss-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'men' },
        { id: 'white-sandalwood', name: 'Royal Oud', tagline: 'Creamy, soft & woody', description: 'A serene and meditative fragrance...', ingredients: ['...'], price: 130, image: 'assets/Royal-Oud-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'men' },
        { id: 'ocean-breeze', name: 'Chocolate Musk', tagline: 'Crisp, clean & refreshing', description: 'Evokes the invigorating scent...', ingredients: ['...'], price: 98, image: 'assets/Chocolate-Musk-100ml.png', images: ['...'], reviews: [], sizes: ['50ml'], category: 'men' },
        
        // --- Women's Collection ---
        { id: 'peony-blush', name: 'Nawab Begum', tagline: 'Delicate, romantic & lush', description: 'A tender and romantic fragrance...', ingredients: ['...'], price: 108, image: 'assets/Nawab-Begum-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'women' },
        { id: 'ebony-wood', name: 'Nawabzadi', tagline: 'Dark, smoky & intense', description: 'A deep and mysterious woody scent...', ingredients: ['...'], price: 155, image: 'assets/Nawabzadi-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'women' },
        { id: 'wild-fig', name: 'H.I.F.', tagline: 'Sweet, green & vibrant', description: 'A Mediterranean escape in a bottle...', ingredients: ['...'], price: 118, image: 'assets/H.I.F-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'women' },
        { id: 'cashmere-dream', name: 'G Bloom', tagline: 'Soft, comforting & luxurious', description: 'A gentle and inviting fragrance...', ingredients: ['...'], price: 132, image: 'assets/G-Bloom-100ml.png', images: ['...'], reviews: [], sizes: ['50ml'], category: 'women' },
        { id: 'saffron-rose', name: 'Tommy G', tagline: 'Spicy, floral & opulent', description: 'A rich and luxurious blend...', ingredients: ['...'], price: 160, image: 'assets/Tommy-G-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'women' },
        { id: 'lemon-verbena', name: 'Bomb S', tagline: 'Crisp, herbal & uplifting', description: 'A refreshingly zesty and green fragrance...', ingredients: ['...'], price: 88, image: 'assets/OLD-Pictures/Bomb-S-100ml.png', images: ['...'], reviews: [], sizes: ['30ml'], category: 'women' },
        { id: 'tobacco-leaf', name: 'G Gold', tagline: 'Rich, aromatic & warm', description: 'A comforting and sophisticated scent...', ingredients: ['...'], price: 170, image: 'assets/G-Gold-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'women' },
        { id: 'ginger-lily', name: 'Flora Moves', tagline: 'Exotic, spicy & floral', description: 'An enchanting floral fragrance...', ingredients: ['...'], price: 128, image: 'assets/Flora-Moves-100ml.png', images: ['...'], reviews: [], sizes: ['30ml', '50ml'], category: 'women' },
        { id: 'smoky-vetiver', name: 'G Flora by Nawab', tagline: 'Earthy, dark & mysterious', description: 'A deep and sophisticated fragrance...', ingredients: ['...'], price: 148, image: 'assets/G-Flora-100ml.png', images: ['...'], reviews: [], sizes: ['50ml', '100ml'], category: 'women' }
    ];
